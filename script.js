...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const b2DistanceSlider = document.getElementById('b2DistanceSlider'); 
    const b2DistanceInput = document.getElementById('b2Distance');     
    ...
    const doorCloserForceContribution = document.getElementById('doorCloserForceContribution'); 
    ...
    const volumeFlowHourResult = document.getElementById('volumeFlowHourResult'); 
    ...
    const updateCalculations = () => {
        ...
        // b2 wird direkt aus dem Input-Feld gelesen, da updateB2RangeAndValue es schon aktualisiert
        let b2 = parseFloat(b2DistanceInput.value);      
